...
# SECURITY NOTE: /api/create-session endpoint moved to internal Python API
# (backend/python_internal_api/internal_api.py)
# This endpoint creates full session tokens and is now only accessible via localhost:5001
# for internal Node.js calls after TOTP verification
